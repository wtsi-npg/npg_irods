package WTSI::NPG::HTS::PacBio::RunAuditorTest;
...
sub require : Test(1) {
  require_ok('WTSI::NPG::HTS::PacBio::RunAuditor');
}
...
sub audit_runs : Test(26) {
  ...
  my $auditor1 = WTSI::NPG::HTS::PacBio::RunAuditor->new(@c_init_args);
  ...
  my $auditor2 = WTSI::NPG::HTS::PacBio::RunAuditor->new(@n_init_args);
  ...
  my $auditor3 = WTSI::NPG::HTS::PacBio::RunAuditor->new(@d_init_args);

package WTSI::NPG::HTS::PacBio::ImageArchiveTest;
...
use WTSI::NPG::HTS::PacBio::ImageArchive;
...
[
  {
    ...
    dataStoreFile=> {
      ...
      path=> 't/data/pacbio/analysis/0000003462/cromwell-job/call-sl_dataset_reports/sl_dataset_reports/75cf695b/call-import_dataset_reports/execution/adapter.report.json',
  ...
  },
  {
    ...
    dataStoreFile=> {
      ...
      name=> 'Control Report',
      fileTypeId=> 'PacBio.FileTypes.JsonReport',
      path=> 't/data/pacbio/analysis/0000003462/cromwell-job/call-sl_dataset_reports/sl_dataset_reports/75cf695b/call-import_dataset_reports/execution/control.report.json',
...
sub require : Test(1) {
  require_ok('WTSI::NPG::HTS::PacBio::ImageArchive');
}
...
sub create_image_archive : Test(2) {
  ...
  my $metadata  = WTSI::NPG::HTS::PacBio::MetaXMLParser->new->parse_file($metafile);
  ...
  my $ia = WTSI::NPG::HTS::PacBio::ImageArchive->new(@init_args);
...
sub create_image_archive_with_report_count : Test(2) {
  ...
  my $ia1 = WTSI::NPG::HTS::PacBio::ImageArchive->new(@init_args1);
  ...
  my $ia2 = WTSI::NPG::HTS::PacBio::ImageArchive->new(@init_args2);
...
sub create_image_archive_with_specified_files : Test(2) {
  ...
  my $metadata  = WTSI::NPG::HTS::PacBio::MetaXMLParser->new->parse_file($metafile, q[pbmeta:]);
